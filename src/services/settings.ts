...
export const settingKeys = ['AI_PROVIDER','OPENAI_API_KEY','OPENAI_MODEL','GEMINI_API_KEY','GEMINI_MODEL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REFRESH_TOKEN','LODGIFY_API_KEY','CLEANING_CALENDAR_ICS_URL','CLOUDFLARE_ACCOUNT_ID','CLOUDFLARE_API_TOKEN','ZOOFY_API_KEY','ZOOFY_AUTH_TOKEN','ZOOFY_PHONE','ZOOFY_AUTO_ACCEPT_ENABLED','ZOOFY_MIN_PRICE','ZOOFY_MAX_DISTANCE_KM','ZOOFY_KEYWORDS','ZOOFY_WHATSAPP_TEMPLATE','ZOOFY_AI_INSTRUCTION'] as const;
